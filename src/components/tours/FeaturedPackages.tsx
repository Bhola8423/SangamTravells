          ...
          >
            ...
            <div className="p-6">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-6 inline-flex items-center justify-center w-full h-11 rounded-xl bg-linear-to-r from-[#e76f51] to-[#d65a3a] text-white font-semibold shadow hover:scale-105 transition"
              >
                Book Now
              </a>
            </div>
